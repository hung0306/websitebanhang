...
import { Table, Space, Button, Input, Card, Tag, Image, Popconfirm, message, Row, Col } from 'antd';
...
const ProductManagement = ({ setActiveComponent, setProductId }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'isActive',
            render: (isActive) => (
                <Tag color={isActive ? 'blue' : 'orange'}>{isActive ? 'Đang bán' : 'Ngừng bán'}</Tag>
            ),
        },
        {
            title: 'Thao tác',
            ...
            <Card title="Quản lý sản phẩm">
                <Row gutter={[16, 16]}>
                    ...
                    <Col xs={24} sm={12} md={8} lg={4} xl={4}>
                        <ProductStockFilter onChange={handleStockFilterChange} value={stockFilter} />
                    </Col>
                    <Col xs={24} sm={12} md={8} lg={4} xl={4}>
                        <ProductStatusFilter onChange={handleStatusFilterChange} value={statusFilter} />
                    </Col>
                </Row>
            </Card>
